...
public class QLChucVu extends javax.swing.JFrame {
    ...
    private DefaultTableModel modelCV;  //Tạo model cho JTable
    int selectedIndex;

    public QLChucVu() {
        initComponents();
        this.setLocationRelativeTo(null);
        modelCV = (DefaultTableModel) TableResultCV.getModel();
        showTableLCV();
    }
    ...
    private void initComponents() {
        ...
        TableResultCV = new javax.swing.JTable();
        jLabel1 = new javax.swing.JLabel();
        txtFind = new javax.swing.JTextField();
        btnFind = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Quản lý chức vụ");
        ...
        TableResultCV.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "STT", "ID chức vụ", "Tên chức vụ"
            }
        ));
        TableResultCV.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TableResultCVMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(TableResultCV);
        if (TableResultCV.getColumnModel().getColumnCount() > 0) {
            TableResultCV.getColumnModel().getColumn(0).setMinWidth(50);
            TableResultCV.getColumnModel().getColumn(0).setMaxWidth(50);
            TableResultCV.getColumnModel().getColumn(1).setMinWidth(150);
            TableResultCV.getColumnModel().getColumn(1).setMaxWidth(150);
        }
        ...
        txtFind.setToolTipText("Nhập ID hoặc tên chức vụ để tìm kiếm ");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        var check = new Check();
        if (check.isNullOrEmpty(txtTenCV.getText())) {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        // TODO add your handling code here:
        selectedIndex = TableResultCV.getSelectedRow();
        if (list.isEmpty()) {
            ...
            if (check.isNullOrEmpty(txtTenCV.getText())) {
                ...
                ChucVu cv = list.get(selectedIndex);
                cv.setTenChucVu(txtTenCV.getText());
                new ChucVuController().Update(cv);
                showTableLCV();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (list.isEmpty()) {
            ...
            ChucVu cv = list.get(selectedIndex);
            new ChucVuController().Delete(cv.getID());
    ...
    private void TableResultCVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableResultCVMouseClicked
        // TODO add your handling code here:
        selectedIndex = TableResultCV.getSelectedRow();
        ChucVu cv = list.get(selectedIndex);
        txtTenCV.setText(cv.getTenChucVu());
    }//GEN-LAST:event_TableResultCVMouseClicked
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        ...
        if (!(kyTu.isBlank())) {
            list = new ChucVuController().findByChar(kyTu);
            modelCV.setRowCount(0);
            for (ChucVu cv : list) {
                modelCV.addRow(new Object[]{
                    TableResultCV.getRowCount() + 1,
                    cv.getID(),
                    cv.getTenChucVu(),
                });
            }
    ...
    private javax.swing.JTable TableResultCV;
    ...
    private void showTableLCV() {
        list = new ChucVuController().getlistCV();
        ...
        for (ChucVu sp : list) {
            modelCV.addRow(new Object[]{
                ...
                TableResultCV.getRowCount() + 1, sp.getID(), sp.getTenChucVu()
            });
        }
    }
